...
public class SymbolTest {
    ...
    //     Symbol intSymbol = table.create("int");
    //     Symbol floatSymbol = table.create("float");
    //     Symbol stringSymbol = table.create("string");
    //     Symbol boolSymbol = table.create("boolean");
    //     Symbol voidSymbol = table.create("void");
    //     Symbol nullSymbol = table.create("null");


    //     Map<String , Symbol> map = table.getMap();

    //     assertSame(table.getSymbole("int"), map.get("int"));
